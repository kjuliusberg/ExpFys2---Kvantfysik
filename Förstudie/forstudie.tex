...
Denna förstudie presenterar en metod för att analysera emissionsspektrum för ett okänt grundämne.
Det okända grundämnet exciteras inuti en ljuskälla och ett linjespektrum avges då grundämnet deexciteras.
Detta linjespektrum förs sedan in i en spektrummeter, där enskilda våglängder av ljus väljs ut för att sedan föras in i ett fotomultiplikatorrör.
I fotomultiplikatorröret förstärks ljuset och översätts till en elektrisk signal som mäts med en picoamperemeter.
Genom att jämföra den elektriska signalstyrkan för varje våglängd kan ett emissionsspektrum produceras, 
och utifrån emissionsspektrumet kan därefter ett energinivådiagram produceras.
...
Kvanttalen är huvudkvanttalet $n$, bankvanttalet $l$, det magnetiska kvanttalet $m$ och spinnkvanttalet $s$\cite{griffiths2018quantum_mechanics}.
...
$h$ är plancks konstant, $n$ är kvanttalet, $R$ är Rydbergs konstant och $c_0$ är ljusets hastighet i vakuum\cite{physicshandbook}.
...
Bankvanttalet $l$ är dock strikt mindre än $n$, vilket innebär att för varje ''skal'' $n$ finns det $n-1$ underskal relaterade till kvanttalet $l$\cite{griffiths2018quantum_mechanics}.
Dessa underskal benämns enligt konvention med bokstäver istället för siffror, så de första 4 underskalen kallas s, p, d och f istället för 1, 2, 3 och 4\cite{bayfield_electron_configuration}.
...
Avslutningsvis finns även spinnkvanttalet $s$, där elektronen kan ha spinn $\frac{1}{2}$ (spinn upp) eller spinn $-\frac{1}{2}$ (spinn ned)\cite{griffiths2018quantum_mechanics}.
...
vilket ger upphov till ett linjespektrum där varje spektrallinje motsvarar en övergång mellan två energitillstånd.
...
Alla energiövergångar är dock inte tillåtna, utan bestäms av så kallade urvalsregler, vilka bestämmer vilka övergångar som är tillåtna\cite{griffiths2018quantum_mechanics}.
För enelektronsystem, som till exempel väte, gäller urvalsregeln
\begin{equation}
    \Delta l = \pm 1 \text{\cite{physicshandbook}}.
\end{equation}
...
\begin{figure}[ht]
    ...
    följer urvalsregeln $\Delta l = \pm 1$\cite{griffiths2018quantum_mechanics}.}}
